...
public interface ShipInfoLoader {
    ...
    /**
     * @param id
     * @return the name of the ship, if the id is recognized, or an empty Optional if not
     */
    Optional<String> getShipName(String id);

    /**
     * @param id
     * @return the description of the ship, if the id is recognized, or an empty Optional if not
     */
    Optional<String> getShipDescription(String id);

    /**
     * @param id
     * @return the SpriteFilePath of the ship, if the id is recognized, or an empty Optional if not
     */
