...
public class InputComponentTankImpl implements InputComponent{
    ...
    public void calculateMovement(GameObject player, GameObject enemy) {
        ...
        if (enemy.getPosition().x() > player.getPosition().x() && Math.abs(enemy.getPosition().x() - player.getPosition().x()) > 300) {
            right = true;
        } else if(enemy.getPosition().x() > player.getPosition().x() && Math.abs(enemy.getPosition().x() - player.getPosition().x()) < 300){
            right = false;
        } else if(enemy.getPosition().x() < player.getPosition().x() && Math.abs(enemy.getPosition().x() - player.getPosition().x()) < 300) {
            right = true;
        } else {
        ...
        if (enemy.getPosition().y() > player.getPosition().y() && Math.abs(enemy.getPosition().y() - player.getPosition().y()) > 300) {
            up = true;
        } else if(enemy.getPosition().y() > player.getPosition().y() && Math.abs(enemy.getPosition().y() - player.getPosition().y()) < 300){
            up = false;
        } else if(enemy.getPosition().y() < player.getPosition().y() && Math.abs(enemy.getPosition().y() - player.getPosition().y()) < 300) {
            up = true;
        } else {
